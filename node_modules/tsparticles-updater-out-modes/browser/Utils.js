...
export function bounceHorizontal(data) {
    ...
    let bounced = false;
    if ((data.direction === "right" /* OutModeDirection.right */ && data.bounds.right >= data.canvasSize.width && velocity > 0) ||
        (data.direction === "left" /* OutModeDirection.left */ && data.bounds.left <= 0 && velocity < 0)) {
