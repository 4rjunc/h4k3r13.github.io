...
(function (factory) {
    ...
    class Particles {
        ...
        addSplitParticle(parent, splitParticlesOptions) {
            const splitOptions = parent.options.destroy.split, options = (0, Utils_1.loadParticlesOptions)(__classPrivateFieldGet(this, _Particles_engine, "f"), this.container, parent.options), factor = (0, NumberUtils_1.getValue)(splitOptions.factor);
            options.color.load({
                value: {
