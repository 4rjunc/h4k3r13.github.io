...
class Container {
    constructor(engine, id, sourceOptions) {
        ...
        this.density = 1;
        this._options = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"), this);
        this.actualOptions = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"), this);
    ...
    async init() {
        ...
        this._options = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"), this, this._initialSourceOptions, this.sourceOptions);
        this.actualOptions = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"), this, this._options);
        this.retina.init();
        this.canvas.init();
